...
class GpsWpCommander():
    ...
    def start_wpf(self):
        ...
        pose_stamped.pose.position.x = wps.position.latitude
        pose_stamped.pose.position.y = wps.position.longitude
        pose_stamped.pose.position.z = wps.position.altitude
        
        # Assign the orientation
        pose_stamped.pose.orientation = wps.orientation
