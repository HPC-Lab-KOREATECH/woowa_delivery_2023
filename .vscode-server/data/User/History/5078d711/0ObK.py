...
from pyquaternion import Quaternion
from nav_msgs.msg import Odometry
from geometry_msgs.msg import Quaternion as GeometryQuaternion
...
class OdomPublisher(Node):
    ...
    def imu_callback(self, data):  # IMU 콜백 함수
        ...
        # Update orientation using angular velocity from IMU
        self.th += data.angular_velocity.z * dt
        # Integrate linear acceleration to get velocity (after removing gravity)
        ax = data.linear_acceleration.x
        ay = data.linear_acceleration.y - GRAVITY  # Assuming IMU z-axis is up. Adjust if different orientation.
        self.vx += ax * dt
        self.vy += ay * dt
